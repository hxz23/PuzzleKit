...
open class PuzzleLogicComponent {
    public weak var dataSource: PuzzleLogicComponentDatasource?

    public weak var adapter: PuzzleAdapter?

    public weak var eventBus: PuzzleEventBus?

    var displayUIComponents = [PuzzleAbstractUIComponent]()
...
public extension PuzzleLogicComponent {
    var isVisible: Bool {
