...
public class PuzzleBroadcaster {
    fileprivate var observersDic = [String: Any]()

    fileprivate let notificationQueue = DispatchQueue(label: "com.swift.puzzle.event.dispatch.queue", attributes: .concurrent)
